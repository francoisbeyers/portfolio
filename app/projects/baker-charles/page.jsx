...
import bcMain from "../../../public/www.bakercharles.com_.png";
  ...
  return (
    <main className="flex flex-col py-10 text-left">
      ...
      <div className="w-full mt-10 mb-3">
        <Image src={bcMain} alt="Câr Y Môr" width={"100vw"} height={"100%"} />
      </div>
      ...
      <div className="w-full mb-3">
        <Image src={bcMac} alt="Câr Y Môr" width={"100vw"} height={"100%"} />
      </div>
    </main>
  );
}
